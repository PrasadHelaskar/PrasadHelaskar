# 👋 Hi, I'm Prasad Helaskar  

**SDET | Python + Java Automation | UI + API Testing | Framework Design | Pytest | TestNG | SaaS Domain**

I’m a QA Automation Engineer with 2+ years of experience designing **scalable UI & API automation frameworks**.  
I focus on solving real-world testing problems such as **flaky tests**, **dynamic locators**, **token-based authentication**, and **multi-environment execution**.
...
- ☁ Experience testing SaaS web applications  
...
### **Automation & Testing**
- Selenium, Pytest, TestNG, Requests  
- API Testing, REST, JSON Schema  

### **Framework Design**
- Page Object Model  
- Modular API Client Architecture  
- Central Auth Resolvers  
- Multi-environment Configurations  
- Logging + HTML Reports  
...
🔗 **LinkedIn:** https://www.linkedin.com/in/prasadhelaskar    
📧 **Email:** helaskarprasad@gmail.com   
